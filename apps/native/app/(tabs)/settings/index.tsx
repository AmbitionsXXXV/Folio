	...
	return (
		<Container className="flex-1" disableScroll disableTopInset>
			...
			>
										...
										<Text className="text-muted text-xs">
											<Trans
												components={{
													1: (
														<Text
															className="font-semibold text-accent text-xs"
															style={{ fontFamily: 'LeckerliOne' }}
														/>
													),
												}}
				...
				{session?.user && (
					<>
						<Text className="mt-4 mb-3 font-semibold text-danger text-lg">
				...
				<View className="mt-auto items-center pt-8">
					...
					<Text className="text-muted text-xs" style={{ fontFamily: 'LeckerliOne' }}>
					...
					<Dialog.Content>
						<View className="mb-5 gap-1.5">
							<View className="mb-2 flex-row items-center gap-2">
								<HugeiconsIcon color={dangerColor} icon={Logout03Icon} size={20} />
						...
						<View className="flex-row justify-end gap-3">
							...
							<Button className="bg-danger" onPress={handleSignOutConfirm} size="sm">
