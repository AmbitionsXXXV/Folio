...
import { entrySources, sources } from "../db/schema"
import type { NewEntrySource, NewSource, Source } from "../db/schema"
 ...
 */
export class SourcesRepository implements BaseRepository<
  Source,
  NewSource,
  UpdateSourceInput
> {
