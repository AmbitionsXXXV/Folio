...
export const JAPANESE_TYPING_EXERCISES: JapaneseTypingExercise[] = [
	{
		...
		tokens: [
			...
			{ surface: '毎日', reading: 'まいにち', romaji: 'mainichi', pos: 'adverb' },
			{ surface: '日本語', reading: 'にほんご', romaji: 'nihongo', pos: 'noun' },
	...
	},
	{
		...
		tokens: [
			...
			{ surface: 'を', reading: 'を', romaji: 'o', pos: 'particle' },
			{ surface: '読みます', reading: 'よみます', romaji: 'yomimasu', pos: 'verb' },
		],
	},
	{
		id: 'weekend-movie',
		...
		tokens: [
			{ surface: '週末', reading: 'しゅうまつ', romaji: 'shuumatsu', pos: 'noun' },
			{ surface: 'に', reading: 'に', romaji: 'ni', pos: 'particle' },
			{ surface: '友達', reading: 'ともだち', romaji: 'tomodachi', pos: 'noun' },
	...
	},
	{
		...
		tokens: [
			...
			{ surface: 'に', reading: 'に', romaji: 'ni', pos: 'particle' },
			{ surface: 'ひらがな', reading: 'ひらがな', romaji: 'hiragana', pos: 'noun' },
			{ surface: 'と', reading: 'と', romaji: 'to', pos: 'particle' },
			{ surface: 'カタカナ', reading: 'カタカナ', romaji: 'katakana', pos: 'noun' },
			{ surface: 'を', reading: 'を', romaji: 'o', pos: 'particle' },
			{
				surface: '覚えました',
				reading: 'おぼえました',
	...
	},
	{
		...
		tokens: [
			...
			{ surface: '練習', reading: 'れんしゅう', romaji: 'renshuu', pos: 'noun' },
			{ surface: 'を', reading: 'を', romaji: 'o', pos: 'particle' },
			{
				surface: '続けました',
				reading: 'つづけました',
