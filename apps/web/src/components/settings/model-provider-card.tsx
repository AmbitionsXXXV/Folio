...
export function ModelProviderCard({
	...
	const handleSaveConfig = useCallback(
		(apiKey: string, baseUrl: string) => {
			...
			toast.success(t('settings.models.configSaved', { provider: provider.name }))
		},
						...
						<div className="flex items-center justify-between">
							...
							<div className="flex items-center gap-2">
								...
								<CollapsibleTrigger
									...
									className="inline-flex size-9 items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium text-sm transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
								>
									<HugeiconsIcon
										className={cn(
			...
			<DialogContent className="sm:max-w-md">
				<DialogHeader>
					<DialogTitle className="flex items-center gap-2">
						{t('settings.models.configureProvider', { provider: provider.name })}
					</DialogTitle>
					<DialogDescription>
				...
				<div className="space-y-4 py-4">
					<div className="space-y-2">
						<Label htmlFor="provider-api-key">{t('settings.models.apiKey')}</Label>
						<Input
							autoComplete="off"
							id="provider-api-key"
