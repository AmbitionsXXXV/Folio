...
export const PromptInputActionAddAttachments = ({
	...
	return (
		...
		>
			<HugeiconsIcon className="mr-2" icon={Image01Icon} size={16} /> {label}
		</DropdownMenuItem>
	)
}
...
export const PromptInputSubmit = ({
	...
	if (status === 'submitted') {
		Icon = <HugeiconsIcon className="animate-spin" icon={RefreshIcon} size={16} />
	} else if (status === 'streaming') {
		Icon = <HugeiconsIcon icon={SquareIcon} size={16} />
