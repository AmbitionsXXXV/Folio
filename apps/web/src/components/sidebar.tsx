...
function Sidebar({
	...
	// On mobile, render Sheet component
	if (isMobile) {
		return (
	...
	// On desktop (or when isMobile is undefined during SSR), render fixed sidebar
	return (
		<div
...
function SidebarContent({ className, ...props }: React.ComponentProps<'div'>) {
	return (
		<div
			className={cn(
				'etc-sidebar-content flex min-h-0 flex-1 flex-col overflow-y-auto overflow-x-hidden group-data-[collapsible=icon]:overflow-hidden',
				className
			)}
