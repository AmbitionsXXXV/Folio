			...
			>
				...
				{showCloseButton && (
					<DialogPrimitive.Close
						...
						render={
							<Button
								className="absolute top-[18px] right-3 z-10"
								size="icon-sm"
								variant="ghost"
							/>
						}
