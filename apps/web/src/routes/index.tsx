		...
		<section className="relative overflow-hidden pt-32 pb-20 md:pt-40 md:pb-28">
			...
			<div className="relative mx-auto max-w-6xl px-6">
				<div className="mx-auto max-w-3xl text-center">
					<Badge
						className="mb-6 animate-fade-in gap-1.5 px-3 py-1"
						variant="secondary"
					>
					...
					<h1 className="animate-fade-in font-bold font-display text-4xl leading-tight tracking-tight delay-100 md:text-6xl md:leading-tight">
					...
					<p className="mx-auto mt-6 max-w-2xl animate-fade-in text-lg text-muted-foreground leading-relaxed delay-200 md:text-xl">
						{t(
					...
					<div className="mt-10 flex animate-fade-in flex-wrap items-center justify-center gap-4 delay-300">
						<Link to="/register">
				...
				{/* Hero product mockup */}
				<div className="relative mx-auto mt-16 max-w-4xl animate-fade-in delay-400">
					<div className="rounded-2xl border border-border/50 bg-card/60 p-3 shadow-2xl backdrop-blur-sm">
						<div className="rounded-xl border border-border/30 bg-card p-6">
							<div className="mb-4 flex items-center gap-3">
								...
								<div className="flex-1 rounded-lg bg-muted/50 px-4 py-1.5 text-center text-muted-foreground text-xs">
	...
	return (
		...
		>
			...
			<div className="relative">
				...
				>
					<HugeiconsIcon className="size-6 text-foreground/80" icon={feature.icon} />
				</div>
				<h3 className="mb-2 font-display font-semibold text-lg">{feature.title}</h3>
...
function StepCard({
	...
	step: { number: string; title: string; description: string; icon: IconSvgElement }
	index: number
	isLast: boolean
}) {
	const ref = useRef<HTMLDivElement>(null)
	...
	return (
		...
		>
			...
			<div className="relative mx-auto mb-5 flex size-20 items-center justify-center rounded-2xl border border-border/50 bg-card/80 shadow-sm backdrop-blur-sm">
				<span className="absolute -top-2 -right-2 flex size-7 items-center justify-center rounded-full bg-primary font-bold font-number text-primary-foreground text-sm">
					{step.number}
				</span>
				<HugeiconsIcon className="size-8 text-primary" icon={step.icon} />
			</div>
			<h3 className="mb-2 font-display font-semibold text-xl">{step.title}</h3>
				...
				<div className="mt-14 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
								...
								<div className="flex-1 text-center" key={day}>
									<div
										className={cn(
											...
											i < 3 && 'bg-green-500/15 text-green-600 dark:text-green-400',
					...
					>
						<div className="mt-4 rounded-lg border border-border/30 bg-card/50 p-4">
							<div className="mb-3 flex gap-2 border-border/30 border-b pb-3">
								{['B', 'I', 'U', 'H1', 'H2', '</>'].map((btn) => (
									<div
										className="flex size-7 items-center justify-center rounded bg-muted/40 font-mono text-muted-foreground text-xs"
										key={btn}
									>
										{btn}
									</div>
...
function StatCard({
	...
	return (
		...
		>
			...
			<p className="font-bold font-display text-3xl tabular-nums">{stat.value}</p>
				...
				<div className="relative overflow-hidden rounded-3xl border border-border/50 bg-card/50 p-10 text-center backdrop-blur-sm md:p-16">
					...
					<div className="relative">
						...
						<div className="mt-8 flex flex-wrap items-center justify-center gap-4">
							<Link to="/register">
								<Button className="cursor-pointer gap-2 px-8 text-base" size="lg">
			...
			<div className="mx-auto max-w-6xl px-6">
				<div className="flex flex-col items-center justify-between gap-6 md:flex-row">
					<div className="flex items-center gap-2.5">
						...
						<span className="font-display font-semibold text-sm">FolioNote</span>
					</div>
