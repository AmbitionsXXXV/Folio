...
export type AiCompactRequestBody = {
	chatId: string
	provider: string
	apiKey: string
	baseUrl?: string
...
export type CaptionImageRequestBody = {
	attachmentId: string
	provider?: string
	apiKey?: string
	baseUrl?: string
...
export type InternalCaptionImageRequestBody = {
	userId: string
	attachmentId: string
	model?: string
	force?: boolean
...
export type CompactRouteResponse = {
	chatId: string
	messages: UIMessage[]
	summary: string
...
export type CompactExecutionInput = {
	userId: string
	chatId: string
	provider: AiProvider
	model?: string
...
export type AuthenticatedUser = { userId: string; locale: string }
