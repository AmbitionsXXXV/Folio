        ...
        <Body className="bg-background font-sans">
          <Container className="mx-auto my-0 max-w-[600px] overflow-hidden rounded-xl bg-card shadow-lg">
            ...
            <Section className="px-8 py-10">
              <Heading className="m-0 mb-6 text-2xl font-semibold text-foreground">
                Reset Your Password
              </Heading>

              <Text className="m-0 mb-4 text-base leading-7 text-foreground">
                Hi {userName},
              </Text>
              ...
              <Section className="my-8 text-center">
                <Button
                  className="inline-block rounded-lg px-8 py-4 text-base font-semibold text-white no-underline"
                  href={resetUrl}
                  style={{
                    background:
              ...
              <Text className="text-foreground-muted m-0 mb-3 text-sm leading-6">
              ...
              <Text className="text-foreground-light m-0 mb-4 text-center text-xs">
                © {new Date().getFullYear()} FolioNote. All rights reserved.
              </Text>

              <Text className="text-foreground-light m-0 mb-2 text-xs">
                If the button doesn't work, copy and paste this link into your
                browser:
              </Text>
              <Link
                className="text-brand text-xs break-all no-underline"
                href={resetUrl}
              >
                {resetUrl}
              </Link>
