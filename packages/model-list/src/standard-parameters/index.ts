      ...
      : T extends ["string", "null"]
        ...
        : T extends "string"
          ...
          : T extends "boolean"
            ? boolean
            : never
type TypeType<K extends ModelParamsKeys> = NonNullable<
  ModelParamsOutputSchema[K]
>["type"]
type DefaultType<K extends ModelParamsKeys> = NonNullable<
  ModelParamsOutputSchema[K]
>["default"]
type _StandardImageGenerationParameters<
  P extends ModelParamsKeys = ModelParamsKeys
> = {
...
export type RuntimeImageGenParams = Pick<
  _StandardImageGenerationParameters,
  "prompt"
> &
  Partial<Omit<_StandardImageGenerationParameters, "prompt">>
export type RuntimeImageGenParamsKeys = keyof RuntimeImageGenParams
export type RuntimeImageGenParamsValue =
  RuntimeImageGenParams[RuntimeImageGenParamsKeys]

// Validation function
export function validateModelParamsSchema(
  paramsSchema: unknown
): ModelParamsOutputSchema {
