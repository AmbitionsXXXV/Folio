...
export const openaiChatModels: AIChatModelCard[] = [
  ...
  },
  {
    ...
    contextWindowTokens: 128_000,
    description:
      "GPT-5.1 Chat: the ChatGPT variant of GPT-5.1, built for chat scenarios.",
  ...
  },
  {
    ...
    contextWindowTokens: 1_047_576,
    description:
      "GPT-4.1 nano is the fastest and most cost-effective GPT-4.1 model.",
...
export const openaiTTSModels: AITTSModelCard[] = [
  {
    description:
      "The latest text-to-speech model optimized for real-time speed.",
    displayName: "TTS-1",
    id: "tts-1",
    pricing: {
      units: [
