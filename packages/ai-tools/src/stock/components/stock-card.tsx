import { ChartContainer } from "@folionote/ui/charts"
import type { ChartConfig } from "@folionote/ui/charts"
        ...
        <div className="relative z-10 grid gap-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="rounded-lg bg-surface-secondary/30 px-3 py-2 backdrop-blur-sm">
              ...
              <p className="mt-0.5 font-mono text-lg font-bold text-foreground tabular-nums">
                {priceValue}
              </p>
            </div>
            <div className="rounded-lg bg-surface-secondary/30 px-3 py-2 backdrop-blur-sm">
