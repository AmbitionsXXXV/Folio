			...
			<div className="relative z-10 grid gap-3 text-xs">
				<div className="flex items-center gap-2">
					...
					<div className="min-w-0">
						<div className="truncate font-semibold text-foreground">Web Search</div>
						<div className="truncate text-muted-foreground text-xs">{query}</div>
					</div>
				</div>
				...
				<div className="grid gap-2">
					{results.map((result) => (
						<a
							...
							target="_blank"
						>
							<div className="truncate font-medium text-foreground text-xs group-hover:text-primary">
								{result.title}
							</div>
